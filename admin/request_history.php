...
try {
    ...
    error_log('[Admin Request History] Error: ' . $e->getMessage());
    $requests = [];
...
<head>
    ...
    <title>Request History - Admin</title>
    ...
    <div class="lg:ml-72 min-h-screen">
        <div class="bg-gradient-to-r from-blue-700 to-blue-900 border-b border-blue-800 sticky top-0 z-10 shadow-lg">
            <div class="flex items-center px-4 lg:px-8 py-4 gap-3">
                <h2 class="text-2xl lg:text-3xl font-bold text-white">Request History</h2>
            </div>
        </div>
        <div class="p-4 lg:p-6" data-aos="fade-up" data-aos-duration="800">
            ...
            <div class="bg-white rounded-xl shadow-md border border-gray-200">
                ...
                <?php if ($totalRecords > $recordsPerPage): $queryParams = $_GET; ?>
                    <div class="bg-gray-50 px-4 lg:px-6 py-4 border-t border-gray-200 flex flex-col lg:flex-row items-center justify-between gap-4">
