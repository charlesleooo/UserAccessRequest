...
try {
    ...
    $pdf->Cell(120, 6, $request['requestor_name'] ?? '', 1, 0, 'L');
    $pdf->Cell(30, 6, 'BU/Department:', 1, 0, 'L');
    $pdf->Cell(60, 6, ($request['business_unit'] ?? '') . ' / ' . ($request['department'] ?? ''), 1, 0, 'L');
    $pdf->Cell(12, 6, 'Date:', 1, 0, 'L');
    $pdf->Cell(40, 6, $currentDate, 1, 1, 'L');
