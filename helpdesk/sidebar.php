...
// Get pending requests count for help desk
$pendingCount = 0;
try {
    require_once '../config.php';
    $stmt = $pdo->query("SELECT COUNT(*) FROM uar.access_requests WHERE status = 'pending_help_desk'");
        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="analytics.php" 
                   class="flex items-center p-2 rounded-lg group <?php echo $current_page == 'analytics.php' ? 'text-white bg-blue-700' : 'text-gray-900 hover:bg-gray-100'; ?>">
                    <svg class="w-8 h-8 transition duration-75 <?php echo $current_page == 'analytics.php' ? 'text-white' : 'text-gray-500 group-hover:text-gray-900'; ?>" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
                        <path d="M16.975 11H10V4.025a1 1 0 0 0-1.066-.998 8.5 8.5 0 1 0 9.039 9.039.999.999 0 0 0-1-1.066h.002Z"/>
                        <path d="M12.5 0c-.157 0-.311.01-.565.027A1 1 0 0 0 11 1.02V10h8.975a1 1 0 0 0 1-.935c.013-.188.028-.374.028-.565A8.51 8.51 0 0 0 12.5 0Z"/>
                    </svg>
            ...
            <li>
                <a href="user_management.php" 
                   class="flex items-center p-2 rounded-lg group <?php echo $current_page == 'user_management.php' ? 'text-white bg-blue-700' : 'text-gray-900 hover:bg-gray-100'; ?>">
                    <svg class="w-8 h-8 transition duration-75 <?php echo $current_page == 'user_management.php' ? 'text-white' : 'text-gray-500 group-hover:text-gray-900'; ?>" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
