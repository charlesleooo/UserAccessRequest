...
// Authorize: allow either a logged-in requestor OR a logged-in superior OR a logged-in help desk user
...
if (!$isRequestor && !$isSuperior && !$isHelpDesk) {
    echo json_encode([
        'success' => false,
...
try {
    ...
    // If this submission originates from a Superior or Help Desk, ensure employee_id aligns with their session
    if ($isSuperior || $isHelpDesk) {
