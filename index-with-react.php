...
<head>
    ...
    <!-- Vite + React Integration (optional - can be enabled for React features) -->
    <?php 
    // Uncomment the following lines to enable React on this page:
    // include 'vite_helpers.php'; 
    // echo vite_assets(['resources/js/app.jsx']); 
    ?>
</head>
    ...
    <div class="max-w-2xl w-full bg-white rounded-2xl shadow-2xl p-10 space-y-10">
        ...
        <div class="text-center space-y-4">
            ...
            <p class="text-gray-600">
                Now with React + Vite support! 
                <a href="react-test.php" class="text-blue-600 hover:underline">View React Demo</a>
            </p>
        </div>
