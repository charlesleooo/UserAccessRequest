<?php
// Unified sidebar usage for process owner; legacy retained below for reference
...
// Get pending requests count for process owner
$pendingCount = 0;
try {
        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="create_request.php" class="flex items-center p-2 rounded-lg group <?php echo $current_page === 'create_request.php' ? 'text-white bg-blue-700' : 'text-gray-900 hover:bg-gray-100'; ?>">
                    <svg class="w-8 h-8 transition duration-75 <?php echo $current_page === 'create_request.php' ? 'text-white' : 'text-gray-500 group-hover:text-gray-900'; ?>" fill="currentColor" viewBox="0 0 20 20">
            ...
            <li>
                <a href="request_history.php" class="flex items-center p-2 rounded-lg group <?php echo $current_page === 'request_history.php' ? 'text-white bg-blue-700' : 'text-gray-900 hover:bg-gray-100'; ?>">
                    <svg class="w-8 h-8 transition duration-75 <?php echo $current_page === 'request_history.php' ? 'text-white' : 'text-gray-500 group-hover:text-gray-900'; ?>" fill="currentColor" viewBox="0 0 20 20">
            ...
            <!-- Review History (Completed decisions you've made) -->
            <li>
