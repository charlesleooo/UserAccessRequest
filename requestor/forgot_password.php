...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_SERVER['HTTP_X_REQUESTED_WITH']) && $_SERVER['HTTP_X_REQUESTED_WITH'] === 'XMLHttpRequest') {
    ...
    try {
        ...
        $resetUrl = "http://{$_SERVER['HTTP_HOST']}/uar/requestor/reset_password.php?token=" . $encodedToken;
        
        // Log the generated URL for debugging
        error_log("Generated reset URL for {$employee_email}: {$resetUrl}");
        ...
        try {
            ...
            $mail->Body = "
                ...
                <p><a href='{$resetUrl}' style='padding: 10px 20px; background-color: #0084FF; color: white; text-decoration: none; border-radius: 5px;'>Reset Password</a></p>
