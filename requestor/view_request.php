...
<div class="ml-0 md:ml-72 transition-all duration-300">
    ...
    <div class="p-6">
        ...
        <div class="flex justify-between items-center" data-aos="fade-up" data-aos-duration="800" data-aos-delay="500">
            ...
            <a href="cancel_request.php?id=<?php echo $request['id']; ?>" class="inline-flex items-center px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors"
