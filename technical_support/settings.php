...
<head>
    ...
    <title>Settings - Technical Support</title>
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <div class="flex-1 min-w-0">
                            <p class="text-sm font-medium text-gray-900 truncate">
                                <?php echo htmlspecialchars($_SESSION['admin_name'] ?? 'Technical Support'); ?>
                            </p>
                            <p class="text-xs text-gray-500 truncate">
                                <?php echo htmlspecialchars($_SESSION['role'] ?? 'technical_support'); ?>
                            </p>
                        </div>
                    </div>
                </div>
