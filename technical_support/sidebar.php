<?php
// Unified sidebar usage for technical support; legacy retained below for reference
$current_page = basename($_SERVER['PHP_SELF']);
$ROLE = 'technical_support';
include __DIR__ . '/../includes/role_sidebar.php';
/* Legacy static sidebar code retained for design reference.
<?php
// Detect current page filename
$current_page = basename($_SERVER['PHP_SELF']);

// Get pending requests count for technical support
$pendingCount = 0;
try {
...
<aside id="sidebar" x-data x-bind:class="(typeof sidebarOpen==='undefined' || sidebarOpen) ? 'translate-x-0 lg:translate-x-0' : '-translate-x-full lg:translate-x-0'" class="fixed top-0 left-0 z-40 w-72 h-screen transition-transform -translate-x-full lg:translate-x-0" aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto bg-white border-r border-gray-200">
        ...
        <ul class="space-y-2 font-medium">
            ...
            <!-- Create Request -->
            <li>
                <a href="create_request.php" class="flex items-center p-2 rounded-lg group <?php echo $current_page === 'create_request.php' ? 'text-white bg-blue-700' : 'text-gray-900 hover:bg-gray-100'; ?>">
                    <svg class="w-8 h-8 transition duration-75 <?php echo $current_page === 'create_request.php' ? 'text-white' : 'text-gray-500 group-hover:text-gray-900'; ?>" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M9.546.5a9.5 9.5 0 1 0 9.5 9.5 9.51 9.51 0 0 0-9.5-9.5ZM13.788 11h-3.242v3.242a1 1 0 1 1-2 0V11H5.304a1 1 0 0 1 0-2h3.242V5.758a1 1 0 0 1 2 0V9h3.242a1 1 0 1 1 0 2Z" />
                    </svg>
                    <span class="ms-3">Create Request</span>
                </a>
            </li>

            <!-- Request History -->
            <li>
                <a href="request_history.php" class="flex items-center p-2 rounded-lg group <?php echo $current_page === 'request_history.php' ? 'text-white bg-blue-700' : 'text-gray-900 hover:bg-gray-100'; ?>">
                    <svg class="w-8 h-8 transition duration-75 <?php echo $current_page === 'request_history.php' ? 'text-white' : 'text-gray-500 group-hover:text-gray-900'; ?>" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M10 2a8 8 0 1 0 8 8 8.011 8.011 0 0 0-8-8Zm1 12H9V9h4v2h-2Z" />
                    </svg>
            ...
            <li>
                <a href="review_history.php"
                    class="flex items-center p-2 rounded-lg group <?php echo $current_page === 'review_history.php' ? 'text-white bg-blue-700' : 'text-gray-900 hover:bg-gray-100'; ?>">
                    <svg class="w-8 h-8 transition duration-75 <?php echo $current_page === 'review_history.php' ? 'text-white' : 'text-gray-500 group-hover:text-gray-900'; ?>" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <span class="ms-3">Review History</span>
                </a>
            </li>
