...
<head>
    ...
    <title>System Settings - UAR Admin</title>
            ...
            <div class="bg-gradient-to-r from-indigo-600 to-purple-600 border-b border-gray-200 sticky top-0 z-30 shadow-lg">
                <div class="flex justify-between items-center px-8 py-4">
                    <div>
                        ...
                        <p class="text-indigo-100 text-sm mt-1">Configure system-wide settings and preferences</p>
                    </div>
                </div>
            </div>
            <div class="p-8">
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-12 text-center">
                    ...
                    <h3 class="text-2xl font-semibold text-gray-700 mb-2">System Settings</h3>
                    <p class="text-gray-500 mb-6">This feature is coming soon. You'll be able to configure email settings, workflow rules, and other system preferences here.</p>
