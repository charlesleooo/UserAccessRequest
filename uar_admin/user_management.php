        ...
        try {
            switch ($_POST['action']) {
                case 'update':
                    ...
                    // Validate role
                    $valid_roles = ['requestor', 'admin', 'help_desk', 'superior', 'technical_support', 'process_owner', 'uar_admin'];
                ...
                <div class="p-4 md:p-5">
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        ...
                        <div class="col-span-2 sm:col-span-1">
                            <label for="edit_company" class="block mb-2 text-sm font-medium text-gray-900">Company</label>
                        ...
                        <div class="col-span-2">
                            ...
                            <select id="edit_role" name="role" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5" required="">
                                ...
                                <option value="uar_admin">UAR Admin</option>
                            </select>
                        </div>
                    </div>
                ...
                <div class="modal-body">
                    <form id="addEmployeeForm" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                        ...
                        <div class="grid gap-4 mb-4 grid-cols-2">
                            ...
                            <div class="col-span-2 sm:col-span-1">
                                <label for="add_company" class="block mb-2 text-sm font-medium text-gray-900">Company</label>
